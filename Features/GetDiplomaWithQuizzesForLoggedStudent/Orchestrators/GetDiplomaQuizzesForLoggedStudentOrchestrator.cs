...
using ExaminationSystem.Features.GetDiplomaWithQuizzesForLoggedStudent.Queries;
using ExaminationSystem.Features.GetDiplomaWithQuizzesForLoggedStudent.Queries.GetDiplomaQuizzes;
using ExaminationSystem.Features.GetDiplomaWithQuizzesForLoggedStudent.Queries.GetQuizSummaryForStudent;


namespace ExaminationSystem.Features.GetDiplomaWithQuizzesForLoggedStudent.Orchestrators
{
