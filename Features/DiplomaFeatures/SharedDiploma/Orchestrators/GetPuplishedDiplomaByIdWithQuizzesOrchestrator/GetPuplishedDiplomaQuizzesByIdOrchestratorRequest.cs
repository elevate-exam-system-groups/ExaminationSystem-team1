using ExaminationSystem.Features.DiplomaFeatures.SharedDiploma.Orchestrators.GetPuplishedDiplomaByIdWithQuizzesOrchestrator.DTOS;
using ExaminationSystem.Features.DiplomaFeatures.SharedDiploma.Queries;
using ExaminationSystem.Features.DiplomaFeatures.SharedDiploma.Queries.GetPublishedDiplomaRecord;

namespace ExaminationSystem.Features.DiplomaFeatures.SharedDiploma.Orchestrators.GetPuplishedDiplomaByIdWithQuizzesOrchestrator
{
