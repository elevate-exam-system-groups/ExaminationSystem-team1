using ExaminationSystem.Features.Common.DiplomaRequests.Queries.GetPublishedDiplomaRecord.DTOS;
using ExaminationSystem.Features.Common.Request;

namespace ExaminationSystem.Features.Common.DiplomaRequests.Queries.GetPublishedDiplomaRecord
{
