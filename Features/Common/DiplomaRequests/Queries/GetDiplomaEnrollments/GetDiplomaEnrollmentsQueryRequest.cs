using ExaminationSystem.Features.Common.DiplomaRequests.Queries.GetDiplomaEnrollments.DTOS;
using ExaminationSystem.Features.Common.Request;

namespace ExaminationSystem.Features.Common.DiplomaRequests.Queries.GetDiplomaEnrollments
{
