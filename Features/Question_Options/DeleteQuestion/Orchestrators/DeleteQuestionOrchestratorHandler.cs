using ExaminationSystem.Features.QuestionFeatures.DeleteQuestion.Commands.DeleteOptions;
using ExaminationSystem.Features.QuestionFeatures.DeleteQuestion.Commands.DeleteQuestionOnly;
using ExaminationSystem.Features.QuestionFeatures.DeleteQuestion.Dtos;
using ExaminationSystem.Features.QuestionFeatures.DeleteQuestion.Queries.CheckActiveAttempts;
using ExaminationSystem.Features.QuestionFeatures.DeleteQuestion.Queries.GetQuestionInfo;
